    ...
    <>
      ...
      <div className="project-section">
        <div className="project-section__inner contained">
            <h1 className="project-section__title title-white">{project.title}</h1>
            <article className="project__info">
                <h2 className="project__info-title title-acc--dark">Che cos'è?</h2>
            ...
            <article className="project__info">
                <h1 className="project__info-title title-acc--dark">Di quali tecnologie fa uso?</h1>
                {formatText(project.techs)}
            </article>
            <article className="project__info">
                <h1 className="project__info-title title-acc--dark">Le sfide:</h1>
      ...
      <section className="project__links">
                <h1 className="project__links-title title title-dark">I link:</h1>
                <LinksStripe
                content={links} 
                style='black'
                />
